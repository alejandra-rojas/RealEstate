...
public static class DatabaseSeeder
{
    ...
    public static void Seed(this WebApplicationFactory<Program> app)
    {
        using var serviceScope = app.Services.CreateAsyncScope();
        SeedDatabase(serviceScope.ServiceProvider.GetService<PortfolioDbContext>()!);
    }
    public static void SeedDatabase(PortfolioDbContext context)
    {
